...
・文末に「他に気になることや、お話しされたいことがあればお聞かせください。」「何か質問があれば〜」など、話題を流す・切り上げる締めも使わない。
...
- **「画面下の参照リンク」**は、別メッセージ【このターンの参照リンク】でページが列挙されているときだけ案内する。列挙がないときは書かない（電話など具体名で案内する）。
...
- 抽象語だけで終わらない。「詳細」「利用方法」「注意点」などの語を使うときは、案内先を明示する（参照リンクが表示される場合は画面下の参照リンク、表示されない場合は電話など具体名）。
...
const PROMPT_COMPLAINT = [
  ...
  "・話題を流す締めも禁止。「他に気になることや、お話しされたいことがあればお聞かせください。」「何か質問があれば〜」等。",
