...
/** アシスタントアイコン画像（あとで差し替え） */
const ASSISTANT_AVATAR_SRC = "./assets/images/assistant-avatar.png";
const ASSISTANT_AVATAR_ALT = "相談アシスタント";

function createAssistantAvatar() {
  const avatar = document.createElement("div");
  avatar.className = "assistant-avatar";
  avatar.style.cssText =
    "flex:0 0 70px;width:70px;height:70px;margin:0;padding:0;overflow:hidden;border-radius:50%;";

  const img = document.createElement("img");
  img.src = ASSISTANT_AVATAR_SRC;
  img.alt = ASSISTANT_AVATAR_ALT;
  img.width = 70;
  img.height = 70;
  img.style.cssText =
...
/** アシスタント用：アイコン + 吹き出しの横並び行 */
function createAssistantRow(bubble) {
...
function addStreamingAssistantShell() {
  ...
  wrap.appendChild(createAssistantRow(bubble));
